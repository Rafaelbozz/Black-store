...
        iconURL: "https://i.ibb.co/J3rR09C/Gif-Bot-Cyans.gif" // substitua pelo link da sua foto
      })
      .setDescription(
...
      )
      .setColor("#5865F2")
      .setFooter({ text: "Sistema Desenvolvido Pela Nexus Solutions" })
      .setTimestamp();
...
          .setURL("https://discord.com/developers/applications") // substitua pelo link desejado
      );
...
        
        
    await interaction.update({ content: ``, embeds: [embed], ephemeral: true, components: [row2, row3,row4]/* row4, row3]*/ })
}
